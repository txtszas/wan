		...
		<tr>
			...
			<?php
					if ( empty( $profileuser->simple_local_avatar ) )
						echo '<span class="description">' . '请上传图片来更换头像' . '</span>';
					else 
						echo '
							<input type="checkbox" name="simple-local-avatar-erase" value="1" /> ' . '删除头像' . '<br />
							<span class="description">' . '通过上传新图片更新现在的头像' . '</span>
						';		
				} else {
					if ( empty( $profileuser->simple_local_avatar ) )
